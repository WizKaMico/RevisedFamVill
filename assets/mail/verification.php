  ...
  date_default_timezone_set('Asia/Manila');
    ...
    $subject = 'ONLINE CLINIC SYSTEM | EMAIL VERIFICATION : '.strtoupper($email).' ';
    ...
    $message = '
      ...
      <head>
        <meta charset="UTF-8">
        <title>ONLINE CLINIC SYSTEM | EMAIL VERIFICATION</title>
      </head>
      <body>
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td class="content-block powered-by">
                        Powered by <a href="#">ONLINE CLINIC SYSTEM</a>.
                      </td>
                    </tr>
                  </table>
                </div>
