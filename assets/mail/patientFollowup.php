<?php
  ...
  date_default_timezone_set('Asia/Manila');
    ...
    $subject = ''.strtoupper($business_name).'| FOLLOW UP NOTIFICATION : '.strtoupper($email).' ';
    ...
    $message = '
      ...
      <head>
        <meta charset="UTF-8">
        <title>'.strtoupper($business_name).' | FOLLOW UP NOTIFICATION</title>
      </head>
      <body>
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            ...
                            -->
                            <p>Hi '.$guardian.',</p>
                            <p>This is a reminder for your upcoming follow-up appointment. Please see the details below and contact us if you need to make any changes!</p><br>
                            <p><h3 style="text-align:center;"><b>FOLLOW UP DATE : '.$schedule_date.'</b></h3></p>
                          </td>
                        </tr>
                      </table>
                    </td>
