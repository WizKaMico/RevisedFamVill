<?php
  ...
  date_default_timezone_set('Asia/Manila');
    ...
    $subject = ''.strtoupper($business_name).'| RESCHEDULE NOTIFICATION : '.strtoupper($email).' ';
    ...
    $message = '
      ...
      <head>
        <meta charset="UTF-8">
        <title>'.strtoupper($business_name).' | RESCHEDULE NOTIFICATION</title>
      </head>
      <body>
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            ...
                            -->
                            <p>Hi '.$guardian.',</p>
                            <p>Your appointment under patient '.$patient.' has been successfully rescheduled. Please see the updated below!</p><br>
                            <p><h3 style="text-align:center;"><b>RESCHEDULE DATE : '.$schedule_date.'</b></h3></p>
                          </td>
                        </tr>
                      </table>
                    </td>
