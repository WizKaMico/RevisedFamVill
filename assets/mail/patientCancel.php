<?php
  ...
  date_default_timezone_set('Asia/Manila');
    ...
    $subject = ''.strtoupper($business_name).'| CANCEL NOTIFICATION : '.strtoupper($email).' ';
    ...
    $message = '
      ...
      <head>
        <meta charset="UTF-8">
        <title>'.strtoupper($business_name).' | CANCEL NOTIFICATION</title>
      </head>
      <body>
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            ...
                            -->
                            <p>Hi '.$guardian.',</p>
                            <p>Your appointment has been cancelled. Let us know anytime if youd like to set a new one!</p><br>
                          </td>
                        </tr>
                      </table>
                    </td>
